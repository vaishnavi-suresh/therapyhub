...
import { getMyConversationsController, getClientConversationsController, getConversationController, createConversationController, updateConversationController, deleteConversationController, closeConversationController } from '../controllers/conversationsController';
...
conversationRouter.get('/client/:user_id', checkJwt, enrichUserFromDb, requiredRoles('therapist'), getClientConversationsController);
